...
function phza24Verify($ROOT_URL, $CLIENT_EMAIL, $LICENSE_CODE, $MYSQLI_LINK = null){}
function phza24AutoloadHelpers($MYSQLI_LINK = null, $FORCE_VERIFICATION = 0){}
function aplVerifySupport($MYSQLI_LINK = null){}
function aplVerifyUpdates($MYSQLI_LINK = null){}
function phza24UpdateLicense($MYSQLI_LINK = null){}
function phza24UninstallLicense($MYSQLI_LINK = null){}
