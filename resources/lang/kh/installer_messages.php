...
return [
     ...
     * Shared translations.
     */
    'title' => config('app.name', 'Phza24').' Installer',
    'next' => 'Next Step',
    'back' => 'Previous',
    'finish' => 'Install',
    'forms' => [
     ...
     */
    'installed' => [
        'success_log_message' => config('app.name', 'Phza24').' Installer successfully INSTALLED on ',
    ],
    ...
    'updater' => [
         ...
         * Shared translations.
         */
        'title' => config('app.name', 'Phza24').' Updater',
        ...
        'log' => [
            'success_message' => config('app.name', 'Phza24').' Installer successfully UPDATED on ',
        ],
    ],
];
